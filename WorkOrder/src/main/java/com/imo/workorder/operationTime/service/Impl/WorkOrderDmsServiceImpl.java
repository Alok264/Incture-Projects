...
public class WorkOrderDmsServiceImpl implements WorkOrderDmsService {
	...
	public ResponseEntity<?> uploadWorkOrderDmsObj(MultipartFile file) throws Exception {
		...
		String URL = WorkOrderDmsConstants.DMS_URL + WorkOrderDmsConstants.DMS_REPO_ID + "/"
				+ WorkOrderDmsConstants.DMS_REPO_ROOT + "/" + WorkOrderDmsConstants.DMS_FOLDER_NAME;
	...
	public ResponseEntity<?> downloadWorkOrderDmsObj(String objectId) throws Exception {
		String url = WorkOrderDmsConstants.DMS_URL + WorkOrderDmsConstants.DMS_REPO_ID + "/"
				+ WorkOrderDmsConstants.DMS_REPO_ROOT + "?objectId=" + objectId
				+ "&cmisselector=content&download=attachment";
		try {
	...
	public ResponseEntity<?> deleteWorkOrderDmsObj(String objectId, boolean flag) throws Exception {
		...
		String URL = WorkOrderDmsConstants.DMS_URL + WorkOrderDmsConstants.DMS_REPO_ID + "/"
				+ WorkOrderDmsConstants.DMS_REPO_ROOT;
	...
	private String getAccessToken() {
		...
		HttpPost httpPost = new HttpPost(WorkOrderDmsConstants.DMS_TOKEN_ENDPOINT);
	...
	private boolean restoreObject(String objectId) {
		String URL = WorkOrderDmsConstants.DMS_URL + WorkOrderDmsConstants.DMS_REPO_ID + "/"
				+ WorkOrderDmsConstants.DMS_REPO_ROOT + "?cmisation=restoreObject&objectId=" + objectId;
