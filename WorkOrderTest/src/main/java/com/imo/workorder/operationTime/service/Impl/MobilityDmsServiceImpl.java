...
import com.imo.workorder.operationTime.constants.MobilityDmsConstants;
import com.imo.workorder.operationTime.dto.MobilityDmsResponseDto;
import com.imo.workorder.operationTime.model.MobilityDms;
import com.imo.workorder.operationTime.repo.MobilityDmsRepo;
...
@Service
@Slf4j
public class MobilityDmsServiceImpl implements MobilityDmsService {

	@Autowired
	private MobilityDmsRepo dmsrepo;

//	@Autowired
//	private DestinationReaderUtil destRepo;

	@Override
	public ResponseEntity<?> uploadMobilityDmsObj(MultipartFile file, String equipmentID) throws Exception {

		String URL = returnURL1() + "/" + MobilityDmsConstants.DMS_FOLDER_NAME;
			...
			if (statusCode == 404) {
				...
				try {
					dmsrepo.save(returnWorkOrderDms(objectId, fileName, "file", folderId,
							MobilityDmsConstants.DMS_REPO_NAME, equipmentID));
				} catch (Exception e) {
					deleteMobilityDmsObj(objectId, false);
	...
	@Override
	public ResponseEntity<?> downloadMobilityDmsObj(String objectId) throws Exception {
	...
	@Override
	public ResponseEntity<?> deleteMobilityDmsObj(String objectId, boolean flag) throws Exception {
...
//		String tokenEndpoint = map.get("tokenurl");
		String tokenEndpoint = MobilityDmsConstants.DMS_TOKEN_ENDPOINT;
		...
		try {
			body = "grant_type="
					+ URLEncoder.encode(MobilityDmsConstants.DMS_GRANT_TYPE, StandardCharsets.UTF_8.toString())
					+ "&client_id="
					+ URLEncoder.encode(MobilityDmsConstants.DMS_CLIENT_ID, StandardCharsets.UTF_8.toString())
					+ "&client_secret="
					+ URLEncoder.encode(MobilityDmsConstants.DMS_CLIENT_SECRET, StandardCharsets.UTF_8.toString())
					+ "&response_type="
					+ URLEncoder.encode(MobilityDmsConstants.DMS_RESPONSE_TYPE, StandardCharsets.UTF_8.toString());
	...
	private MobilityDmsResponseDto returnResponseDto(String status, String code, Map<String, Object> data) {
		MobilityDmsResponseDto responseDto = new MobilityDmsResponseDto();
	...
	private MobilityDms returnWorkOrderDms(String objectId, String documentName, String documentType, String folderId,
			String repoName, String equipmentID) {
		MobilityDms workorder = new MobilityDms();
...
//		Map<String, String> map = getDestinationData();
//		String URL = map.get("baseUrl") + "/browser/" + MobilityDmsConstants.DMS_REPO_ID + "/root";
//		return URL;
//	}

	private String returnURL1() throws Exception {
		String URL = MobilityDmsConstants.DMS_URL + MobilityDmsConstants.DMS_REPO_ROOT;
		return URL;
	}
}
